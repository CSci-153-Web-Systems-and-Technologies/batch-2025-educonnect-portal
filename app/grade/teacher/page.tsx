...
import { StudentRow } from "@/components/dashboard/StudentManagementTable";
...
export default function TeacherGradePage() {
  ...
  const [students, setStudents] = useState<StudentRow[]>([
    ...
    { id: "2", name: "Maria Clara", email: "21-1-02430@vsu.edu.ph", status: "Honor", notes: "" },
    { id: "3", name: "Jose Rizal", email: "21-102431@vsu.edu.ph", status: "Highest Honor", notes: "Perfect score in Math" },
    { id: "4", name: "Andres Bonifacio", email: "21-102432@vsu.edu.ph", status: " ", notes: "Needs improvement" },
  ...
  const filters: FilterItem[] = [
    { id: "q", title: "Quarter", icon: CalendarIcon, iconColor: "text-red-500", type: "select", value: selectedQuarter, onChange: setSelectedQuarter, options: ["1st Quarter", "2nd Quarter", "3rd Quarter", "4th Quarter"] },
    { id: "c", title: "Class", icon: Users, iconColor: "text-white", type: "select", value: selectedClass, onChange: setSelectedClass, options: ["Grade 7 - A", "Grade 8 - A", "Grade 9 - A", "Grade 10 - A"] },
    { id: "s", title: "Honor Filter", icon: Funnel, iconColor: "text-indigo-500", type: "select", value: selectedStatus, onChange: setSelectedStatus, options: ["All Students", "Highest Honor", "High Honor", "Honor", " "] }
  ];
