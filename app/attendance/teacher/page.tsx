            ...
            <CardContent className="flex justify-center pb-6 pt-4">
              {type === "date" && (
                <Popover open={open} onOpenChange={setOpen}>
                  <PopoverTrigger asChild>
                    <Button
                      variant="outline"
                      className="w-90 justify-between text-left rounded-xl border border-black dark:border-neutral-700 bg-white dark:bg-transparent text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-neutral-800"
                    >
              ...
              {type === "class" && (
                <Select value={selectedClassList} onValueChange={setSelectedClassList}>
                  <SelectTrigger className="w-90 rounded-xl border border-black dark:border-neutral-700 bg-white dark:bg-transparent text-gray-900 dark:text-white">
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <div className="flex gap-4 flex-wrap">
              <span className="px-4 py-2 rounded-full border border-black dark:border-neutral-700 text-sm font-semibold text-gray-700 dark:text-gray-200">
      ...
      <Card className="rounded-3xl border border-black dark:border-transparent bg-white dark:bg-neutral-900 p-6 shadow-lg">
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex gap-3">
            ...
            <Button
              className="rounded-lg px-4 border-black dark:border-neutral-700 text-gray-900 dark:text-white"
            ...
            {multipleEditMode && (
              <Button
                className="rounded-lg px-4 bg-green-600 hover:bg-green-700 text-white"
                onClick={() => {
                  setStudents((prev) =>
                    prev.map((s) =>
        ...
        <div className="flex flex-col gap-4">
          ...
          {filteredStudents.map((student) => {
            ...
            return (
              <div
                key={student.id}
                className="flex items-center justify-between border border-black dark:border-neutral-800 rounded-2xl p-3 bg-white dark:bg-neutral-900 shadow-sm"
              >
                <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  {multipleEditMode ? (
                    ...
                    >
                      <SelectTrigger className="w-40 rounded-full border border-black dark:border-neutral-700 bg-white dark:bg-transparent text-gray-900 dark:text-white">
                        <SelectValue />
                      </SelectTrigger>
                    ...
                    <>
                      ...
                      {isInlineEditing ? (
                        <div className="flex items-center gap-2">
                          ...
                          >
                            <SelectTrigger className="w-36 rounded-full border border-black dark:border-neutral-700 bg-white dark:bg-transparent text-gray-900 dark:text-white">
                              <SelectValue />
                            </SelectTrigger>
                            <SelectContent className="bg-white dark:bg-neutral-900">
                              <SelectItem value="Present">Present</SelectItem>
                        ...
                        <>
                          ...
                          <Button
                            ...
                            className="px-3 py-1 rounded-lg inline-flex items-center gap-2 hover:bg-gray-100 dark:hover:bg-neutral-800"
                          >
